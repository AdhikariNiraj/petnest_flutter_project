...
class _BirdPageState extends State<BirdPage> {
  String selectedCategory = 'Birds'; // Default category
  String searchQuery = ''; // Search query entered by the user

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Birds')), // Title for the page
      body: Column(
        children: [
          // Category Selection (Birds will be pre-selected)
          ...
          const Expanded(
            child: Center(
              child: Text(
                'No pet birds available for now',
                style: TextStyle(
